...
var armory = new Location("Armory Room",[weaponRack],myEnemies.slice(0),"A large room with many weapon racks, and also a large variety of weapons mounted on the walls", "images/pixelHallway.png");//
